...
{
    double a=2*x*x*x+3*x-1;    //write the equation whose roots are to be determined
    return a;
}
int main()
{
    ...
    while (fabs(a-b)>=e)        /*if the mod of a-b is greater than the accuracy desired keep                         bisecting the interval*/
    {
        ...
        fb=f(b);
        fc=f(c);
        cout<<"a="<<a<<"     "<<"b="<<b<<"     "<<"c="<<c<<"      fa="<<fa<<"        fb="<<fb<<"     "<<"fc="<<fc<<"     "<<endl;/*print the                             values of a,b,c and fc  after each iteration*/
